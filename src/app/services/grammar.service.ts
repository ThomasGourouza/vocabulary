...
export class GrammarService {
  ...
  private _data!: Array<Grammar>;
  private _selectedData!: Array<Grammar>;
  private _currentItem: Grammar | undefined;
  ...
  public setVariables(name: string, tabIndex: number, validKeys: Array<string>): void {
    this._name = name;
  ...
  get data(): Array<Grammar> {
    return this._data;
  }
  public setData(data: Array<Grammar>): void {
    this._data = data;
  }

  get selectedData(): Array<Grammar> {
    return this._selectedData;
  }
  public setSelectedData(selectedData: Array<Grammar>): void {
    this._selectedData = selectedData;
  }

  get currentItem(): Grammar | undefined {
    return this._currentItem;
  }
  public setCurrentItem(currentItem: Grammar | undefined): void {
